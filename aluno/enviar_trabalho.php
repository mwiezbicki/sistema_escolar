    ...
    <body>
        <div id="box">
            ...
            <?php if(isset($_POST['button'])){
                ...
                $sql_1 = "INSERT INTO envio_de_trabalhos_bimestrais (date, status, id_trabalho, disciplina, trabalho, aluno, nota) VALUES"
                        . "('$date','Aguarda','$id','$dis','$trabalho','$code','')";
                $sql_1 = $pdo->query($sql_1);
                
                (move_uploaded_file($_FILES['trabalho']['tmp_name'],"../trabalhos_alunos/".$trabalho));
                
                echo "<h1>Trabalho enviado com sucesso!<br>Aperte F5 em seu teclado para atualizar a pagina</h1>";
                die;
                ...
                <table width="379" border="0">
                    ...
                    <tr>
                        <td><label for="filefield"></label>
                            <input type="file" name="trabalho" id="filefield"/>
                        </td>
                    </tr>
                    <tr>
    ...
    <?php } ?>
        ...
        <?php if(isset($_POST['button'])){
			...
			$trabalho = "[".$a."]".$trabalho;
                ...
                $sql_2 = "INSERT INTO envio_de_trabalhos_extras (date, status, id_trabalho, disciplina, trabalho, aluno, nota) VALUES ('$date', 'Aguarda', '$id', '$dis', '$trabalho', '$aluno','')";
