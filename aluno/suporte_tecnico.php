                ...
                <?php if (@$_GET['acao'] == 'abrir_chamado') { ?>
                    <?php
                        if (isset($_POST['enviar_mensagem'])) {
                            ...
                            $sql_4 = "INSERT INTO central_mensagem (date, status, emissor, receptor, mensagem, anexo, data_resposta, resposta, anexo_resp) VALUES ('$date', 'Aguarda resposta', '$code', '$setor', '$mensagem', '$anexo', '', '', '')";
                            ...
                            if ($sql_4 == '') {
                                ...
                                $sql_8 = "SELECT * FROM disciplinas WHERE curso = '$serie' AND professor = '$setor'";
                                $sql_8 = $pdo->query($sql_8);
                                foreach ($sql_8 as $res_8):
                                    $professor = $res_8['professor'];
                                endforeach;
                                ...
                                if ($setor == 'COORDENACAO') {
                                    ...
                                    $sql_6 = "INSERT INTO mural_professor (date, status, curso, titulo) VALUES ('$date', 'Ativo', 'Não informado', 'Existe uma nova mensagem enviada pelo aluno para ser respondida')";
            ...
            <?php } ?>
                    ...
                    <tr>
                        <td align="center">
                            ...
                            ?>
                            <?php foreach ($sql_5 as $res_5): ?>
                                <table border="0">
                                    <tr>
                                        <td width="114"><strong>Receptor:</strong></td>
